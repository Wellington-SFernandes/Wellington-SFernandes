# 🧠 Wellington Cyber Profile

<p align="center">
  <img src="https://raw.githubusercontent.com/Wellington-SFernandes/Wellington-SFernandes/main/assets/terminal-gif.gif" width="600"/>
</p>

<p align="center">
  <a href="#sobre-mim">Sobre mim</a> •
  <a href="#tecnologias--ferramentas">Tecnologias & Ferramentas</a> •
  <a href="#laboratorio--estudos">Laboratório & Estudos</a> •
  <a href="#projetos-em-destaque">Projetos</a> •
  <a href="#cursos--certificacoes">Cursos & Certificações</a> •
  <a href="#skills--grafico">Skills</a> •
...
- 📝 Metodologia: **testes éticos, documentação de resultados, automação de processos de pentest**
...
![Medusa](https://img.shields.io/badge/Medusa-orange?logo=linux&logoColor=white)
![Hydra](https://img.shields.io/badge/Hydra-red?logo=linux&logoColor=white)
...
| Área | Atividades |
|------|------------|
| 🔐 Pentest | Testes de intrusão em **Metasploitable, VMs de laboratório** |
| 🌐 Redes | Varredura e análise de portas abertas |
| 📡 Captura de pacotes | Wireshark / tcpdump |
| 🔎 Enumeração | Enum4linux: usuários e compartilhamentos |
| 💣 Ataques simulados | Brute Force SMB/FTP com documentação |

---

## 📌 Projetos em Destaque

- **Automação de ataques SMB e FTP** – scripts próprios para brute force, registro de resultados em arquivos e gráficos de sucesso/falha  
- **Enumeração de rede** – integração de Nmap e Enum4linux para mapear hosts e serviços, identificando vulnerabilidades  
- **Captura e análise de pacotes** – estudo de tráfego real em laboratório para identificar protocolos, credenciais em texto claro e padrões de comunicação  
- **Mini pentest completo em Metasploitable 2** – planejamento, execução, análise e documentação aplicando metodologia prática de pentest  

---

## 📚 Cursos & Certificações (concluídos ou em andamento)
...
- Evoluir para participação em **CTFs e desafios práticos**
